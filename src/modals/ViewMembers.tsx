...
const ViewMembers = (props: ViewMembersProps) => {
  ...
  return isOpen ? (
    <Dialog open={true} onClose={closeModal}>
      ...
      <Dialog.Panel>
        <>
          <div className={`fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 flex flex-col justify-between w-[350px] sm:w-auto h-[472px] rounded-xl space-y-4 p-8 border border-[1px] border-neutral-700 ${ BG_GRADIENT }`}>
