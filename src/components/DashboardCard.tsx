...
const DashboardCard = (props: DashboardCardProps) => {
  ...
  return (
    <div className={`w-auto p-8 rounded-xl flex-grow flex flex-col justify-between items-center hover:text-tinkerYellow hover:border-tinkerYellow border-2 border-neutral-700 transition duration-150 ease-in-out ${ BG_GRADIENT } ${ mini ? ' h-[154px] px-6 py-5' : ' h-[194px] p-8' }`}>
