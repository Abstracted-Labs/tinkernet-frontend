...
// const RPC_PROVIDER = "wss://rpc.astar.network";

// INVARCH const TEST_WALLET = "i4zTcKHr38MbSUrhFLVKHG5iULhYttBVrqVon2rv6iWcxQwQQ";
// ASTAR const TEST_WALLET = "5HGabetgTWWsoRJxdZP11ns2yi1oVaenXEBprfKHp7tpw7NH";
...
const Home = () => {
  ...
  const loadBalances = async (account: InjectedAccountWithMeta) => {
    ...
    const locks = await api.query.balances.locks(account.address);
    ...
    console.log({
      ...
      miscFrozen: formatBalance(miscFrozen, {
        decimals: 12,
        withSi: false,
        forceUnit: "-",
      }),
      feeFrozen: formatBalance(feeFrozen, {
        decimals: 12,
        withSi: false,
        forceUnit: "-",
      }),
